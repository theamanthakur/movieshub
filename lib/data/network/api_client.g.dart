...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<MovieListResponse> getMoviesList(String page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MovieListResponse> getPopularMovies(String page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MovieListResponse> getTopRatedMovies(String page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieListResponse>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'movie/top_rated?language=en-US&${page}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<MovieListResponse> getUpcomingMovies(String page) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MovieListResponse> getSearchResult(String name) async {
    final _extra = <String, dynamic>{};
